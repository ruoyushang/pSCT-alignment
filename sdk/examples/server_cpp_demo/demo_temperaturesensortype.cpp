...
/** Construction of the class TemperatureSensorType.
...
: TemperatureSensorTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
TemperatureSensorType::TemperatureSensorType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: TemperatureSensorTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class TemperatureSensorType with all components.
*/
TemperatureSensorType::TemperatureSensorType(
...
: TemperatureSensorTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void TemperatureSensorType::createTypes()
{
    // Call base class
    TemperatureSensorTypeBase::createTypes();
...
*/
void TemperatureSensorType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    TemperatureSensorTypeBase::clearStaticMembers();
}
