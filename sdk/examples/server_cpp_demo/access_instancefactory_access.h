/******************************************************************************
** access_instancefactory_access.h
**
...
#ifndef __INSTSTANCEFACTORY_Access_
#define __INSTSTANCEFACTORY_Access_
#include <basenodes.h>
...
class CPP_ACCESS_EXPORT InstanceFactoryAccess : public XmlUaNodeFactoryNamespace
{
public:
    InstanceFactoryAccess(OpcUa_UInt16 namespaceIndex);
...
#endif //__INSTSTANCEFACTORY_Access_
