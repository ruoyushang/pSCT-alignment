...
/** Construction of the class MachineType.
...
: MachineTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
MachineType::MachineType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: MachineTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class MachineType with all components.
*/
MachineType::MachineType(
...
: MachineTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void MachineType::createTypes()
{
    // Call base class
    MachineTypeBase::createTypes();
...
*/
void MachineType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    MachineTypeBase::clearStaticMembers();
}
