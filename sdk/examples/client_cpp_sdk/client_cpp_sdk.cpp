...
void connect(UaString& sUrl, SessionSecurityInfo& sessionSecurityInfo)
{
    ...
    cout << "will create 50 sessions and try to connect them all to the server:" << endl;

    vector<UaSession *> vecSession;
    int failed = 0;
    int succeeded = 0;
    for ( int i = 0; i < 50; i++) {
    vecSession.push_back( new UaSession());
    ...
    **********************************************************************/
    status = vecSession.back()->connect(
...
//        g_pUaSession = NULL;
    ...
    cout << "Connected " << succeeded << " sessions; failed " << failed << " sessions." << endl;
}
