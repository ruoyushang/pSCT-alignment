...
const std::map<OpcUa_UInt32, std::pair<std::string, std::vector<std::tuple<std::string, UaNodeId, std::string>>>> PanelObject::METHODS = {
    ...
    {PAS_PanelType_MoveDeltaCoords, {"MoveDeltaCoords", {
                                                            std::make_tuple("Delta x",
                                                                            UaNodeId(OpcUaId_Double),
                                                                            "Desired change in x-coordinate for the panel (in mm)."),
                                                            std::make_tuple("Delta y",
                                                                            UaNodeId(OpcUaId_Double),
                                                                            "Desired change in y-coordinate for the panel (in mm)."),
                                                            std::make_tuple("Delta z",
                                                                            UaNodeId(OpcUaId_Double),
                                                                            "Desired change in z-coordinate for the panel (in mm)."),
                                                            std::make_tuple("Delta xRot",
                                                                            UaNodeId(OpcUaId_Double),
                                                                            "Desired change in x-rotation for the panel (in mm)."),
                                                            std::make_tuple("Delta yRot",
                                                                            UaNodeId(OpcUaId_Double),
                                                                            "Desired change in y-rotation for the panel (in mm)."),
                                                            std::make_tuple("Delta zRot",
                                                                            UaNodeId(OpcUaId_Double),
                                                                            "Desired change in z-rotation for the panel (in mm)."),
                                                        }}
    },
