    ...
    for line in outputfile:
        if "RFP" in line:
            ...
            if out_text is not None:
                ...
                #num_read) + ".csv"
                out_file = "RFP_" + timenow + "_for_vvv_" + str(
                    num_read) + ".csv"
            ...
            with open(out_file, 'w') as outf:
                outf.write("Panel_id,pad_PRF1,pad_PRF4,pad_PRF7,pad_PRF2,pad_PRF5,pad_PRF8,pad_PRF3,pad_PRF6,pad_PRF9,"
                           "pad_TRF1,pad_TRF4,pad_TRF7,pad_TRF2,pad_TRF5,pad_TRF8,pad_TRF3,pad_TRF6,pad_TRF9\n")
        ...
        elif "SecondaryMirror" in line and is_an_data_block:
        ...
        if is_an_TRF_block and is_an_data_block:
            if line == "\n":
                ...
                #print("TRF {} line read".format(line_read))
                #print(line)
                if line_read <2:
                    line2write += ",".join(line.split())+","
                elif line_read == 2:
