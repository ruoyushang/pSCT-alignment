...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Print out mapping for a MPES')
    parser.add_argument('mpes', default='10094', help="MPES ID", type=str)
    parser.add_argument('-H', '--host', default='172.17.10.10', help="Host for DB", type=str)
    args = parser.parse_args()

    testDB = pSCTDB_readonly(args.host)
    testDB.query_mpes(args.mpes)
