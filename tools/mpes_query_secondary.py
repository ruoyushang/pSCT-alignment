...
#included_panels=[2111,2112,2211,2212,2311,2312,2411,2412,2121,2122,2123,2124,2221,2222,2223,2224,2321,2322,2323,2324,2421,2422,2423,2424] # all panels
#included_panels=[2111,2112,2211,2212,2311,2312,2411,2412,2121,2122,2123,2124,2222,2223,2224,2321,2323,2324,2421,2422,2424] #v1 list
#included_panels=[2111,2112,2211,2212,2311,2312,2411,2412,2121,2123,2124,2221,2222,2224,2322,2323,2421,2422,2423,2424] # v2 list
#included_panels=[2111,2112,2212,2312,2411,2121,2122,2123,2124,2221,2222,2223,2224,2321,2322,2323,2324,2421,2422,2423,2424] # v3 list
#included_panels=[2111,2112,2211,2212,2311,2312,2411] # only S1
included_panels=[2121,2122,2123,2124,2221,2222,2223,2224,2321,2322,2323,2324,2421,2422,2423,2424] # only S2
#included_panels=[2111,2112,2211,2212,2311,2312,2411,2121,2122,2123,2221,2222,2223,2224,2321,2322,2323,2324,2421,2422,2423,2424] # fix 2124, 2412
KNOWN_BAD_SENSORS=[10332,10358,10152,10146] # permanent dead
#KNOWN_BAD_SENSORS+=[10351, 10333] # calibrated
#KNOWN_BAD_SENSORS+=[10287] # calibrated, no longer a suspect
#KNOWN_BAD_SENSORS+=[10095,10100] # calibrated
#KNOWN_BAD_SENSORS+=[10006] #  calibrated 
#KNOWN_BAD_SENSORS+=[10113] #  not initialized
