...
included_panels=[2111,2112,2211,2212,2311,2312,2411,2412,2121,2122,2123,2124,2221,2222,2223,2224,2321,2322,2323,2324,2421,2422,2423,2424]
KNOWN_BAD_SENSORS=[10332,10358,10152,10146] # permanent dead
KNOWN_BAD_SENSORS+=[10351, 10333] # working but need alignment before useable
#KNOWN_BAD_SENSORS+=[10287] # calibrated 
#KNOWN_BAD_SENSORS+=[10094, 10163] # These are temporarily laser lost 
