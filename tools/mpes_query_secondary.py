...
#included_panels=[2111,2112,2211,2212,2311,2312,2411,2412] # only S1
included_panels=[2121,2122,2123,2124,2221,2222,2223,2224,2321,2322,2323,2324,2421,2422,2423,2424] # only S2
#included_panels=[2121,2123,2221,2223,2321,2323,2421,2423] # only S2 odd
#included_panels=[2122,2124,2222,2224,2322,2324,2422,2424] # only S2 even

KNOWN_BAD_SENSORS=[10332,10358,10152,10146] # permanent dead
KNOWN_BAD_SENSORS+=[10333] # calibrated
KNOWN_BAD_SENSORS+=[10006] #  calibrated 
KNOWN_BAD_SENSORS+=[10221] #  uncalibrated 
KNOWN_BAD_SENSORS+=[10165] #  CCD pixel damage

KNOWN_BAD_SENSORS+=[10351] # uncalibrated
KNOWN_BAD_SENSORS+=[10156] # Suspect of miscalibration. No record of problem.
