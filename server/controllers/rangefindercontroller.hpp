/**
 * @file rangefindercontroller.hpp
 * @brief Header file for position sensitive device controller class
 */

#ifndef SERVER_RANGEFINDERCONTROLLER_HPP
#define SERVER_RANGEFINDERCONTROLLER_HPP
...
public:
    ...
    RangefinderController(Device::Identity identity, std::shared_ptr<PlatformBase> pPlatform);
    ...
    /// @brief Get the value of a Rangefinder data variable.
    ...
    /// @brief Set the value of a Rangefinder data variable.
    /// @param offset A number used to uniquely identify the data variable to access.
    ...
    /// @brief Call a method on the Rangefinder device.
...
private:
    ...
    /// @brief Pointer to the GASRangefinder object interfacing directly with thee Rangefinder hardware.
...
#endif //SERVER_RANGEFINDERCONTROLLER_HPP
