...
const std::map<OpcUa_UInt32, std::tuple<std::string, UaVariant, OpcUa_Boolean>> PanelObject::ERRORS = {
    {PAS_PanelType_Error0,  std::make_tuple("[0] Actuator 0 Operable Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error1,  std::make_tuple("[1] Actuator 0 Fatal Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error2,  std::make_tuple("[2] Actuator 1 Operable Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error3,  std::make_tuple("[3] Actuator 1 Fatal Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error4,  std::make_tuple("[4] Actuator 2 Operable Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error5,  std::make_tuple("[5] Actuator 2 Fatal Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error6,  std::make_tuple("[6] Actuator 3 Operable Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error7,  std::make_tuple("[7] Actuator 3 Fatal Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error8,  std::make_tuple("[8] Actuator 4 Operable Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error9,  std::make_tuple("[9] Actuator 4 Fatal Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error10, std::make_tuple("[10] Actuator 5 Operable Error", UaVariant(false), OpcUa_False)},
    {PAS_PanelType_Error11, std::make_tuple("[11] Actuator 5 Fatal Error", UaVariant(false), OpcUa_False)},
