...
const std::map<OpcUa_UInt32, std::tuple<std::string, UaVariant, OpcUa_Boolean>> ACTObject::ERRORS = {
    ...
    {PAS_ACTType_Error8,  std::make_tuple("[8] Actuator missed too many steps", UaVariant(false), OpcUa_False)},
    {PAS_ACTType_Error9,  std::make_tuple("[9] Actuator position missed, too far away to recover safely",
                                          UaVariant(false),
                                          OpcUa_False)},
    {PAS_ACTType_Error10, std::make_tuple("[10] Actuator position missed, small enough to recover automatically",
                                          UaVariant(false),
                                          OpcUa_False)},
