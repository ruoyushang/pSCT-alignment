...
: PasObject(name, newNodeId, defaultLocaleId, pNodeManager, identity, pCommIf)
{
    ...
    unsigned vars[] = {
        ...
        PAS_MirrorType_sysOffsets_x,
        PAS_MirrorType_sysOffsets_y,
        PAS_MirrorType_sysOffsets_z,
        PAS_MirrorType_sysOffsets_xRot,
        PAS_MirrorType_sysOffsets_yRot,
        PAS_MirrorType_sysOffsets_zRot};
